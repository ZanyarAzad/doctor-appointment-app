<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
           ...
           <!-- Bio data text area -->
           <textarea id="bio" name="bio" wire:model.defer="state.bio_data" class="mt-1 block w-full border-grey-300 focus:border-indigo-300 focus:ring-indigo-300 focus:ring-opacity-50 rounded-md shadow-sm" placeholder="{{__('Bio Data')}}"></textarea>
